<!DOCTYPE html>
  <html>
    <head>
      ...
      <link href="EXPLICATION_IA.css" rel="stylesheet">
    ...
    <body>
      ...
      <article>
        ...
        <p class="p1"> Ces technologies qui n'ont de cesse d'être développées ont pour objectif d'imiter l’intelligence humaine.
          ...
          du "deep-learning" (ou apprentissage profond en français). Cette notion rapproche en effet l'IA de l'humain puisqu'il
          s'agit de l'apprentissage par l'exemple. Autrement dit, tel un enfant apprenant à reconnaître un arbre à force d'en voir,
          la machine applique exactement la même méthode.Toutefois, celle-ci le fait seule grâce à un réseau de neurones!
          Inondée d'images, seule dans un coin, elle remarque que certains "types" d'images sont récurrentes et les classe dans
          une même catégorie. Récemment, une IA a même appris indépendamment de toute aide humaine à jouer
          au go, jeu de réflexion extrêmement complexe et a réussi à battre le champion du monde en titre. Cette réussite de l'IA
          symbolise également une défaite de l'humain, engendrant de nombreuses inquiétudes.
        </p>
      </article>
